...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiamd1c3Rhdm9hcyIsImEiOiJjazVzdHUwNnUwNThsM21tY2lmbXFocXVvIn0.bn1DtLQ8GYlKePkyEYhE3w';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jgustavoas/ck5su50vy11o71iszr3bbq4fm',
    scrollZoom: false // center: [-118.1133491, 34.111745],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            // console.log(error);
            (0, _alert.showAlert)('error', response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (_response2.data.status = 'success') location.reload(true);
            _context2.next = 10;
            break;
...
if (mapBox) {
  var locations = JSON.parse(mapBox.locations);
